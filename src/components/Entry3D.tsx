...
export const Entry3D: React.FC<Entry3DProps> = ({ onEnter }) => {
  ...
  useEffect(() => {
    ...
    const ambientLight = new THREE.AmbientLight('#121a28', 0.5);
    ...
    const directionalLight1 = new THREE.DirectionalLight('#c8dcea', 1.5);
    directionalLight1.position.set(-8, 8, 4);
    scene.add(directionalLight1);

    const goldSpecularLight = new THREE.DirectionalLight('#b89a5a', 1.0);
    ...
    const animate = () => {
      ...
      if (isEntering) {
        camera.position.z += (-24 - camera.position.z) * 0.035;
        camera.rotation.z += 0.007 * (1.0 + warpFactor * 4); // Twist warp rotation!
    ...
    <div ref={containerRef} className="entry-container">
      ...
      <div className="entry-hud">
        <div className="hud-corner top-left">
          <span className="hud-label">SYSTEM_INIT // VALLE</span>
          <div className="hud-line-h" />
          <div className="hud-line-v" />
        </div>
        <div className="hud-corner top-right">
          <span className="hud-label">
            {hoveredSnowflakeIndex !== null ? `FOCUS: CRYSTAL_0${hoveredSnowflakeIndex + 1}` : 'STATUS: FLOATING'}
          </span>
          <div className="hud-line-h" />
          <div className="hud-line-v" />
        </div>
        <div className="hud-corner bottom-left">
          <span className="hud-label">LAT. 33.3533° S // LON. 70.2492° W</span>
          <div className="hud-line-h" />
          <div className="hud-line-v" />
        </div>
        <div className="hud-corner bottom-right">
          <span className="hud-label">ELEV. 3025M // ANDES CHILE</span>
          <div className="hud-line-h" />
          <div className="hud-line-v" />
        </div>
      </div>
        ...
        <motion.div 
          ...
          >
            <div className="entry-title-group">
              <div className="entry-kicker">Coleção de Inverno</div>
            ...
            <p className="entry-tagline">Onde o vale encontra o inverno</p>
        ...
        {showPreview && (
          ...
          >
            <div className="preview-drawer-header">
              <h2 className="preview-drawer-title">A Curadoria</h2>
              <button className="preview-drawer-close" onClick={() => setShowPreview(false)}>
                Fechar ×
              </button>
            </div>
            <p className="preview-drawer-manifesto">
              "No Valle Showroom, transformamos a proteção contra o frio extremo em uma declaração de estilo silenciosa. Desenvolvemos peças estruturadas sob medida em tecidos nobres, inspiradas na imponência gelada dos Vales Andinos do Chile."
            </p>
            
            <div className="preview-cards-list">
              <div className="preview-card-item">
                <div className="preview-card-img-wrapper">
                  <img src="/showroom-entry/entry_1.jpg" alt="Sobretudos Andinos" />
                </div>
                <div className="preview-card-info">
                  <span className="preview-card-tag">Alfaiataria</span>
                  <h3 className="preview-card-title">Sobretudos de Lã Pura</h3>
                  <p className="preview-card-desc">Cortes estruturados sob medida e tecidos nobres importados para resistir ao frio extremo com elegância atemporal.</p>
                </div>
              </div>

              <div className="preview-card-item">
                <div className="preview-card-img-wrapper">
                  <img src="/showroom-entry/entry_3.jpg" alt="Malharia & Suéteres" />
                </div>
                <div className="preview-card-info">
                  <span className="preview-card-tag">Tricot Premium</span>
                  <h3 className="preview-card-title">Malharia & Suéteres</h3>
                  <p className="preview-card-desc">Fios de cashmere e alpaca patagônica densos, projetados com tramas artesanais clássicas para máximo conforto térmico.</p>
                </div>
              </div>

              <div className="preview-card-item">
                <div className="preview-card-img-wrapper">
                  <img src="/showroom-entry/entry_5.jpg" alt="Equipamento de Altitude" />
                </div>
                <div className="preview-card-info">
                  <span className="preview-card-tag">Performance</span>
                  <h3 className="preview-card-title">Equipamento de Altitude</h3>
                  <p className="preview-card-desc">Acessórios em couro nobre e forros térmicos de tecnologia suíça, ideais para caminhadas na neve andina.</p>
                </div>
              </div>
            </div>
          </motion.div>
